...
namespace Course_Overview.Migrations
{
    ...
    [Migration("20240806075358_UpdateRegisterCourseTBtoDb")]
    partial class UpdateRegisterCourseTBtoDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LModels.AQ", b =>
                {
                    b.Property<int>("AQId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AQId"));
            ...
            modelBuilder.Entity("LModels.Course", b =>
                {
                    ...
                    b.Property<string>("LabFacilities")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LModels.ExModel.ClassExam", b =>
                {
                    b.Property<int>("ClassID")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("LModels.ExModel.ClassStudent", b =>
                {
                    b.Property<int>("ClassID")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("LModels.ExModel.EX_Answer", b =>
                {
                    ...
                    b.ToTable("EX_Answers");
                });

            modelBuilder.Entity("LModels.ExModel.EX_Exam", b =>
                {
                    b.Property<int>("ExamID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LModels.ExModel.EX_ExamQuestion", b =>
                {
                    b.Property<int>("ExamID")
                        .HasColumnType("int");
                    ...
                    b.ToTable("EX_ExamQuestions");
                });

            modelBuilder.Entity("LModels.ExModel.EX_Lesson", b =>
                {
                    ...
                    b.ToTable("EX_Lessons");
                });

            modelBuilder.Entity("LModels.ExModel.EX_Question", b =>
                {
                    b.Property<int>("QuestionID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EX_Questions");
                });

            modelBuilder.Entity("LModels.ExModel.EX_StudentExamResult", b =>
                {
                    b.Property<int>("StudentID")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
                    ...
                    b.ToTable("EX_StudentExamResults");
                });

            modelBuilder.Entity("LModels.ExModel.EX_Subject", b =>
                {
                    b.Property<int>("SubjectID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LModels.Permission", b =>
                {
            ...
            modelBuilder.Entity("LModels.RegistrationCourse", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RegistrationCourseID"));
            ...
            modelBuilder.Entity("LModels.Role", b =>
                {
            ...
            modelBuilder.Entity("LModels.UserPermission", b =>
                {
            ...
            modelBuilder.Entity("LModels.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LModels.ExModel.ClassExam", b =>
                {
                    ...
                    b.HasOne("LModels.ExModel.EX_Exam", "Exam")
                        .WithMany()
            ...
            modelBuilder.Entity("LModels.ExModel.EX_Answer", b =>
                {
                    b.HasOne("LModels.ExModel.EX_Question", "Question")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("LModels.ExModel.EX_Exam", b =>
                {
                    b.HasOne("LModels.ExModel.EX_Subject", "Subject")
                        .WithMany("Exams")
            ...
            modelBuilder.Entity("LModels.ExModel.EX_Question", b =>
                {
                    b.HasOne("LModels.ExModel.EX_Lesson", "Lesson")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("LModels.RolePermission", b =>
                {
                    b.HasOne("LModels.Permission", "Permission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LModels.Role", "Role")
                        .WithMany("RolePermissions")
